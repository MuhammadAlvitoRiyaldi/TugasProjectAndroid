package id.ac.poliban.mi.vc.alvito.simplecalcapp_032;

import static id.ac.poliban.mi.va.sherli.simplecalcapp_032.R.*;
import static id.ac.poliban.mi.va.sherli.simplecalcapp_032.R.layout.activity_main;
...
import id.ac.poliban.mi.va.sherli.simplecalcapp_032.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mResultTextView = findViewById(id.operation_result_text_view);
        mOperandOneEditText = findViewById(id.operand_one_edit_text);
        mOperandTwoEditText = findViewById(id.operand_two_edit_text);
    }
    /**
    ...
    public void onDiv(View view) {
        try {
            ...
            mResultTextView.setText(getString(string.computationError));
        }
    }
    ...
    private void compute(Calculator.Operator operator) {
        ...
        switch (operator) {
            ...
            case MUL:
                ...
                break;
            default:
                result = getString(string.computationError);
                break;
        }
